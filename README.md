...
The script protects private information using a .env file. To run the script you need to create your own .env file in your directory as shown in the example. 
In my case, I only needed 5 columns out of 6 from the source dataset. I chose the following approach: create a table that matches the source dataset and then drop it later.
